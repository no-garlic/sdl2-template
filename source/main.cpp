...
int main(int argc, char* argv[]) {
    ...
    while (!quit) {
        ...
        SDL_Rect centerRect = {WINDOW_WIDTH/2 - 50, WINDOW_HEIGHT/2 - 50, 100, 100};
        ...
        SDL_Rect movingRect = {
            WINDOW_WIDTH/2 - 25 + xOffset,
            WINDOW_HEIGHT/2 - 25 + yOffset,
            50, 50
        };
        ...
        SDL_Rect blueRect = {WINDOW_WIDTH*3/4 - 50, WINDOW_HEIGHT/2 - 50, 100, 100};
        ...
        SDL_RenderDrawLine(renderer.get(), WINDOW_WIDTH/2, 0, WINDOW_WIDTH/2, WINDOW_HEIGHT);
        ...
        SDL_RenderDrawLine(renderer.get(), trianglePoints[0].x, trianglePoints[0].y, trianglePoints[1].x, trianglePoints[1].y);
        SDL_RenderDrawLine(renderer.get(), trianglePoints[1].x, trianglePoints[1].y, trianglePoints[2].x, trianglePoints[2].y);
        SDL_RenderDrawLine(renderer.get(), trianglePoints[2].x, trianglePoints[2].y, trianglePoints[0].x, trianglePoints[0].y);
